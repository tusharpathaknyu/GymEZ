...
export class ProgressService {
  ...
  static getMockProgressEntries(): ProgressEntry[] {
    ...
    for (let i = 0; i < 30; i++) {
      ...
      entries.push({
        ...
        energy_level: Math.floor(Math.random() * 2) + 4, // 4 or 5
        mood: Math.floor(Math.random() * 2) + 4, // 4 or 5
        notes: i % 7 === 0 ? 'Feeling great today! Increased weights.' : undefined
      });
    }
    ...
    return [
      {
        ...
        user_id: 'user_1',
        title: 'Lose 10 kg',
        description: 'Reach target weight of 70kg through consistent training and nutrition',
        target_value: 70,
        current_value: 75,
        unit: 'kg',
      ...
      },
      {
        ...
        description: 'Maintain consistent workout schedule throughout the month',
        target_value: 16,
        current_value: 14,
        unit: 'workouts',
      ...
      },
      {
        ...
        description: 'Lower body fat percentage through strength training and cardio',
        target_value: 15,
        current_value: 18,
        unit: '%',
  ...
  static getMonthlyProgressData(): { month: string; weight: number; bodyFat: number }[] {
    return [
