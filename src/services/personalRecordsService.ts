...
// The database might use 'created_at' instead of 'achieved_at'
// We'll use 'created_at' as the primary date column for ordering
...
export class PersonalRecordsService {
  ...
  static async createPR(
    ...
    try {
      ...
      return {
        ...data,
        achieved_at: data.achieved_at || data.created_at,
      } as PersonalRecord;
    } catch (error) {
